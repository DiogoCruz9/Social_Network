 ...
 *  @author Kevin Wayne
 */
public class BST_Aed2<Key extends Comparable<Key>, Value> {
  ...
  /*************************************************************************
    ...
    ***************************************************************************/
    ...
    public Iterable<Key> preordem() {
        Queue<Key> queue = new Queue<Key>();
        preordem(root, queue);
        return queue;
    } 

    private void preordem(Node x, Queue<Key> queue) { 
        if (x == null) return; 
        queue.enqueue(x.key);       //nó
        preordem(x.left, queue);     //arvore esquerda
        preordem(x.right, queue);    //arvore direita     
    } 
    
    public Iterable<Key> posordem() {
        Queue<Key> queue = new Queue<Key>();
        posordem(root, queue);
        return queue;
    } 

    private void posordem(Node x, Queue<Key> queue) { 
        if (x == null) return; 
        
        posordem(x.left, queue);     //arvore esquerda
        posordem(x.right, queue);    //arvore direita 
        queue.enqueue(x.key);       //nó
    } 
    ...
    public static void main(String[] args) { 
        BST_Aed2<String, Integer> st = new BST_Aed2<String, Integer>();
